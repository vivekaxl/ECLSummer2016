...
IMPORT * FROM RegressionSuite.Utils;
IMPORT RegressionSuite.Classification as Classification;
IMPORT RegressionSuite.Clustering as Clustering;
IMPORT RegressionSuite.Regression as Regression;
IMPORT RegressionSuite.TimeSeries as TimeSeries;
